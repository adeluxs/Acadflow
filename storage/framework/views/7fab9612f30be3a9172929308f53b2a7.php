...
<nav class="space-y-1" aria-label="Primary navigation">
    ...
    <a href="<?php echo e(route('dashboard')); ?>" class="sidebar-link <?php echo e(request()->routeIs('dashboard') ? 'sidebar-link-active' : ''); ?>">
        <svg class="h-[17px] w-[17px]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.7" d="<?php echo e($icons['home']); ?>"></path></svg><span class="min-w-0 flex-1">Dashboard</span>
        <?php if($dashboardStatus === \App\Services\FeatureAccessService::STATUS_MAINTENANCE): ?>
        ...
        <?php elseif($dashboardStatus === \App\Services\FeatureAccessService::STATUS_DISABLED && $user?->isAdmin()): ?>
...
<?php /**PATH C:\Users\Admin\Desktop\Acadflow\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>