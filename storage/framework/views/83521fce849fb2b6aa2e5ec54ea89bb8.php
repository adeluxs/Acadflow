...
<nav class="space-y-2">
    <a href="<?php echo e(route('dashboard')); ?>"
       class="flex items-center gap-3 px-4 py-3 rounded-2xl border-l-4 transition <?php echo e(request()->routeIs('dashboard') ? 'bg-blue-50 text-blue-700 border-blue-600' : 'text-slate-700 hover:bg-slate-100 border-transparent'); ?>">
    ...
    <?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if(Route::has($routeName)): ?>
            <a href="<?php echo e(route($routeName, $params)); ?>"
               class="flex items-center gap-3 px-4 py-3 rounded-2xl border-l-4 transition <?php echo e($isActive($routeName . '*')); ?>">
                <?php echo sidebarIcon($item['icon']); ?>
    ...
    <a href="<?php echo e(route('settings.index')); ?>"
       class="flex items-center gap-3 px-4 py-3 rounded-2xl border-l-4 transition <?php echo e(request()->routeIs('settings.*') ? 'bg-blue-50 text-blue-700 border-blue-600' : 'text-slate-700 hover:bg-slate-100 border-transparent'); ?>">
        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
        </svg>
        <span class="font-medium">Settings</span>
    </a>
</nav><?php /**PATH C:\Users\Admin\Desktop\uni-management-system\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>