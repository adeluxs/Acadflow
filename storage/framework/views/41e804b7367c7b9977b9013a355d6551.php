...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', \App\Services\SettingService::get('site_name', 'UniAcademic')); ?></title>
    ...
    <meta name="apple-mobile-web-app-title" content="<?php echo e(\App\Services\SettingService::get('site_name', 'UniAcademic')); ?>">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white shadow-2xl p-4">
            <div class="flex items-start justify-between gap-4 mb-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="font-semibold text-sm">Install <?php echo e(\App\Services\SettingService::get('site_name', 'UniAcademic')); ?></h3>
        ...
        <header class="lg:hidden sticky top-0 z-40 bg-white/95 backdrop-blur border-b border-slate-200">
            <div class="flex items-center justify-between px-4 py-3">
                ...
                <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-2">
                    ...
                    <span class="font-semibold text-lg text-slate-900"><?php echo e(\App\Services\SettingService::get('site_name', 'UniAcademic')); ?></span>
                </a>
            ...
            <aside id="sidebar" class="hidden lg:flex lg:w-80 lg:flex-col lg:fixed lg:inset-y-0 lg:left-0 lg:z-30 bg-white border-r border-slate-200">
                <div class="px-6 py-5 border-b border-slate-200">
                    <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-3">
                        ...
                        <div>
                            <h1 class="text-xl font-semibold leading-tight text-slate-900"><?php echo e(\App\Services\SettingService::get('site_name', 'UniAcademic')); ?></h1>
                            <p class="text-xs text-slate-500"><?php echo e(\App\Services\SettingService::get('site_tagline', 'Academic Management Platform')); ?></p>
                        </div>
                    </a>
                </div>
            ...
            <main class="flex-1 lg:pl-80 min-w-0">
                <div class="px-4 sm:px-6 lg:px-8 py-6">
                    ...
                    <div class="hidden lg:flex items-center justify-between mb-8">
                        <div>
                            <h2 class="text-3xl font-semibold text-slate-900"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></h2>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="relative">
                                ...
                                >
                                    <div class="h-8 w-8 rounded-full bg-slate-200 flex items-center justify-center overflow-hidden">
                                        <?php if(auth()->user()?->avatar): ?>
                                            <img src="<?php echo e(asset('storage/' . auth()->user()->avatar)); ?>" alt="Avatar" class="h-full w-full object-cover">
                                        <?php else: ?>
                                ...
                                >
                                    <a href="<?php echo e(route('settings.index')); ?>" class="block px-4 py-3 text-sm text-slate-700 hover:bg-slate-50">
                                        Account Settings
                                    </a>

                                    <?php if(Route::has('profile.show')): ?>
                                        <a href="<?php echo e(route('profile.show')); ?>" class="block px-4 py-3 text-sm text-slate-700 hover:bg-slate-50">
                                            My Profile
                                        </a>
                                    <?php endif; ?>
...
<?php /**PATH C:\Users\Admin\Desktop\uni-management-system\resources\views/layouts/app.blade.php ENDPATH**/ ?>