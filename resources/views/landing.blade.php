...
<head>
    ...
    <title>{{ \App\Services\SettingService::get('site_name', 'UniAcademic') }} - {{ \App\Services\SettingService::get('site_tagline', 'University Academic Management Platform') }}</title>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="font-semibold text-xl text-slate-900">{{ \App\Services\SettingService::get('site_name', 'UniAcademic') }}</span>
                    </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 mb-12">
                    <div class="sm:col-span-2 md:col-span-2 lg:col-span-2">
                        ...
                        <p class="text-sm text-slate-500 mb-4">
                            {{ \App\Services\SettingService::get('site_tagline', 'University Academic Management Platform') }}
                        </p>
                        <p class="text-xs text-slate-400">
                            &copy; {{ date('Y') }} {{ \App\Services\SettingService::get('site_name', 'UniAcademic') }}. All rights reserved.
                        </p>
                    </div>
