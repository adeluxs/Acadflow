...
class KnowledgeCommunityInvitation extends Model
{
    protected $fillable = ['uuid','knowledge_community_id','inviter_id','invitee_id','email','role','status','token_hash','expires_at','responded_at'];
    ...
    public function community() { return $this->belongsTo(KnowledgeCommunity::class, 'knowledge_community_id'); }
